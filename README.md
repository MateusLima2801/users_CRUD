...
<div class="box" display = 'inline-block'>
    <img src="images\lista.jpeg" width=45% padding= '20px'/>
    <span font-size ='20px' text-align ='center'> Lista de Usuários </span>
</div>
<div class="box" display = 'inline-block'>
    <img src="images\form_criar.jpeg" width=45% padding= '20px'/>
    <span  font-size ='20px' text-align ='center'> Criar novo usuário </span>
</div>
<div class="box">
    <img src="images\popup_deletar.jpeg" width=45% padding= '20px'/>
    <span  font-size ='20px' text-align ='center'> Modal para deletar usuário </span>
</div>
<div class="box">
    <img src="images\form_editar.jpeg" width=45% padding= '20px'/>
